...
class RoastProfile:
    def from_proto(self, protoMsg):
        ...
        self.cooldown_fan = FanPoint(
            protoMsg.profile_set.profile.cooldown_fan.time,
            protoMsg.profile_set.profile.cooldown_fan.power,
        )
    ...
    def from_json(self, filename):
        ...
        self.id = base64.b64decode(data["id"])
        self.name = data["name"]
